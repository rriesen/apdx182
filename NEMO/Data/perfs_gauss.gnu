...
set terminal postscript eps color enhanced fontfile '~/.fonts/PetitaMedium.ttf' 26
set size 1.4,1.8
set output 'perfs_gauss.eps'
set pointsize 5
set key right nobox
...
#set ytics 0,5,20 font "PetitaMedium,30"
set title "SCRIP Gaussian ORCA025->T359\n Intel Broadwell, 40 cores per node" font "PetitaMedium,30"
plot [10:12000] [.5:200] 'gauss.dat' u ($1):($12) title "reference" with lp ls 5, '' u ($1):($3) title "1-MPI/40-OpenMP" with lp ls 1, '' u 1:(40*140./($1)) title "ideal" with lp ls 7, '' u ($1):($4) title "2-MPI/20-OpenMP" with lp ls 2, '' u ($1):($2) title "1-MPI/80-OpenMP" with lp ls 3
